...
public class Drawing extends JPanel {
	...
	private List<model.Shapes.Shape> shapes;
	private int playLineColumn;


	public Drawing() {
		super();
		shapes = new ArrayList<model.Shapes.Shape>();
		setBackground(Color.white);
	}

	// getters
    public List<model.Shapes.Shape> getShapes() { return this.shapes; }
    ...
    public boolean containsShape(model.Shapes.Shape s) {
	...
	public void paintComponent(Graphics g) {
		...
		for (model.Shapes.Shape shape : shapes) {
            shape.draw(g);
        }
	}
	...
	public void addShape(model.Shapes.Shape shape) {
		shapes.add(shape);
	}
	...
	public void removeShape(model.Shapes.Shape shape) {
		shapes.remove(shape);
		repaint();
	}

	// EFFECTS: returns the Shape at a given Point in Drawing, if any
	public model.Shapes.Shape getShapesAtPoint(Point point) {
		for (model.Shapes.Shape shape : shapes) {
	...
	public List<model.Shapes.Shape> getShapesAtColumn(int x) {
	    List<model.Shapes.Shape> shapesAtColumn = new ArrayList<model.Shapes.Shape>();
